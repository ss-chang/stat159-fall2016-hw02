...
## Conclusions 
Since the p-value for the estimate of `TV` is essentially 0, we can reject the 
...
deviates from its predicted value by 3.26, meaning $3,260. The $R^2$ value tells 
us that 61% of the variability in `Sales` can be explained by `TV`.